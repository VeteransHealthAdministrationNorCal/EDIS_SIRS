...
for (uq_patientssn in unique(Vitals$PatientSSN)[70:77]){
    ...
    for (i in 1:length(uq_dates)){
      date <-uq_dates[i]
      date_list=list()
      #date_list[[date]] <- get_date_set(date)
      date <-(as.Date(date, origin = "1970-01-01"))
      print(date)
      
      l[[uq_patientssn]][[i]]<-(get_date_set(date))
      #print(typeof(date_list[[date]]))
      #print(get_date_set(date))
